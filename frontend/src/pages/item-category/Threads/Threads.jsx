        ...
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-5 lg:max-w-7xl lg:px-8">
          ...
          <section className="group">
            <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-h-8 xl:aspect-w-7">
              ...
              <button className=" mx-36 my-3 relative flex items-center justify-center text-center rounded-md border border-transparent bg-gray-400 px-6 py-2 text-sm font-medium text-gray-900 hover:bg-black hover:text-white"onClick={() => handleClickAdd(inventoryItem)}>
                  add to cart
                </button>
            </div>
          </section>
